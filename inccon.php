<?php
    ...
    $TEST_SENSOR_LIST = array(array("sensor_id" => 1, "sensor_name" => "Test Sensor 1", "sensor_type" => $SENSOR_TYPE_MOTION), array("sensor_id" => 0, "sensor_name" => "Test Sensor 2", "sensor_type" => $SENSOR_TYPE_LIGHT));
